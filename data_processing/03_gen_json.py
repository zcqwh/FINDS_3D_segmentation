...
task_num = '510_4hittest'  # 根据需要更改任务编号
output_file = f'Z:\\Nana\\FINDS_task\\data\\DATASET\\Task{task_num}\\dataset.json'
imagesTr_dir = f'Z:\\Nana\\FINDS_task\\data\\DATASET\\Task{task_num}\\imagesTr'
imagesTs_dir = f'Z:\\Nana\\FINDS_task\\data\\DATASET\\Task{task_num}\\imagesTs'
labels = {
    "0": 'background',
    "1": 'wing disc'
    # "1": 'salivary glands_L',
...
dataset_name = "FINDS"
modalities = tuple(['FINDS-mcheery'])
...
print(f"Generated dataset.json for Task {task_num}.")
